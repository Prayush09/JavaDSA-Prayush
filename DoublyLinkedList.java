...
public class DoublyLinkedList {
    ...
    public static void main(String[] args) {
        ...
        doubly_ll.insertEnd(28);
        doubly_ll.insertFront(61);
        doubly_ll.insertFront(45);
        doubly_ll.insertEnd(72);

        // insert 11 after head
        doubly_ll.insertAfter(doubly_ll.head, 56);

        // insert 15 after the seond node
        doubly_ll.insertAfter(doubly_ll.head.next, 98);
